...
export async function generateMetadata({ params }: any) {
  ...
  return {
    ...
    description,
    alternates: {
      canonical: `https://globalsalah.com/${lang}/qaza-namaz-calculator`,
      en: `https://globalsalah.com/en/qaza-namaz-calculator`,
      fr: `https://globalsalah.com/fr/qaza-namaz-calculator`,
      ar: `https://globalsalah.com/ar/qaza-namaz-calculator`,
      es: `https://globalsalah.com/es/qaza-namaz-calculator`,
      pt: `https://globalsalah.com/pt/qaza-namaz-calculator`,
      de: `https://globalsalah.com/de/qaza-namaz-calculator`,
      tr: `https://globalsalah.com/tr/qaza-namaz-calculator`,
      ur: `https://globalsalah.com/ur/qaza-namaz-calculator`,
      ru: `https://globalsalah.com/ru/qaza-namaz-calculator`,
      'zh-CN': `https://globalsalah.com/zh-CN/qaza-namaz-calculator`,
      'x-default': `https://globalsalah.com/en/qaza-namaz-calculator`,
    },
    robots: {
      index: false,
      follow: false,
