...
export async function generateMetadata({ params }: any) {
  ...
  return {
    ...
    description,
    alternates: {
      canonical: `https://globalsalah.com/${lang}/99-names-of-allah`,
      languages: {
        en: 'https://globalsalah.com/en/99-names-of-allah',
        fr: 'https://globalsalah.com/fr/99-names-of-allah',
        ar: 'https://globalsalah.com/ar/99-names-of-allah',
        es: 'https://globalsalah.com/es/99-names-of-allah',
        'zh-CN': 'https://globalsalah.com/zh-CN/99-names-of-allah',
        tr: 'https://globalsalah.com/tr/99-names-of-allah',
        de: 'https://globalsalah.com/de/99-names-of-allah',
        pt: 'https://globalsalah.com/pt/99-names-of-allah',
        ur: 'https://globalsalah.com/ur/99-names-of-allah',
        ru: 'https://globalsalah.com/ru/99-names-of-allah',
        'x-default': 'https://globalsalah.com/en/99-names-of-allah',
      },
    },
    robots: {
 index: false,
