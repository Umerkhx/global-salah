...
export async function generateMetadata({ params }: any) {
  ...
  return {
    ...
    description,
    alternates: {
      canonical: `https://globalsalah.com/${lang}/privacy-policy`,
      en: `https://globalsalah.com/en/privacy-policy`,
      fr: `https://globalsalah.com/fr/privacy-policy`,
      ar: `https://globalsalah.com/ar/privacy-policy`,
      es: `https://globalsalah.com/es/privacy-policy`,
      'zh-CN': `https://globalsalah.com/zh-CN/privacy-policy`,
      tr: `https://globalsalah.com/tr/privacy-policy`,
      de: `https://globalsalah.com/de/privacy-policy`,
      pt: `https://globalsalah.com/pt/privacy-policy`,
      ur: `https://globalsalah.com/ur/privacy-policy`,
      ru: `https://globalsalah.com/ru/privacy-policy`,
      'x-default': `https://globalsalah.com/en/privacy-policy`,
    },
    robots: {
      index: false,
      follow: false,
