...
export async function generateMetadata({ params }: any) {
  ...
  return {
    ...
    description,
    alternates: {
      canonical: `https://globalsalah.com/${lang}/madina-tv`,
      en: `https://globalsalah.com/en/madina-tv`,
      fr: `https://globalsalah.com/fr/madina-tv`,
      ar: `https://globalsalah.com/ar/madina-tv`,
      es: `https://globalsalah.com/es/madina-tv`,
      'zh-CN': `https://globalsalah.com/zh-CN/madina-tv`,
      tr: `https://globalsalah.com/tr/madina-tv`,
      de: `https://globalsalah.com/de/madina-tv`,
      pt: `https://globalsalah.com/pt/madina-tv`,
      ur: `https://globalsalah.com/ur/madina-tv`,
      ru: `https://globalsalah.com/ru/madina-tv`,
      'x-default': `https://globalsalah.com/en/madina-tv`,
    },
    robots: {
      index: false,
      follow: false,
