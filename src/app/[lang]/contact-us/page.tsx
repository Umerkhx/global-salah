...
export async function generateMetadata({ params }: any) {
  ...
  return {
    ...
    description,
    alternates: {
      canonical: `https://globalsalah.com/${lang}/contact-us`,
      languages: {
        en: 'https://globalsalah.com/en/contact-us',
        es: 'https://globalsalah.com/es/contact-us',
        fr: 'https://globalsalah.com/fr/contact-us',
        ar: 'https://globalsalah.com/ar/contact-us',
        'zh-CN': 'https://globalsalah.com/zh-CN/contact-us',
        tr: 'https://globalsalah.com/tr/contact-us',
        de: 'https://globalsalah.com/de/contact-us',
        pt: 'https://globalsalah.com/pt/contact-us',
        ur: 'https://globalsalah.com/ur/contact-us',
        ru: 'https://globalsalah.com/ru/contact-us',
        'x-default': 'https://globalsalah.com/en/contact-us',
      },
    },
    robots: {
 index: false,
