...
import { NisaiDownloadDialog } from "./nisai-download-dialog"
...
export function NisaiBookList({ books }: BookListProps) {
  ...
  return (
    <div className="space-y-4">
      ...
      {selectedBook && <NisaiDownloadDialog isOpen={showDialog} onClose={() => setShowDialog(false)} book={selectedBook} />}
    </div>
  )
}
