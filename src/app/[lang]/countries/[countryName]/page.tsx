...
export async function generateMetadata({ params }: any) {
  ...
  return {
    ...
    alternates: {
      canonical: `https://globalsalah.com/${lang}/countries/${country}`,
      languages: {
        en: `https://globalsalah.com/en/countries/${country}`,
        fr: `https://globalsalah.com/fr/countries/${country}`,
        es: `https://globalsalah.com/es/countries/${country}`,
        ar: `https://globalsalah.com/ar/countries/${country}`,
        'zh-CN': `https://globalsalah.com/zh-CN/countries/${country}`,
        tr: `https://globalsalah.com/tr/countries/${country}`,
        de: `https://globalsalah.com/de/countries/${country}`,
        pt: `https://globalsalah.com/pt/countries/${country}`,
        ur: `https://globalsalah.com/ur/countries/${country}`,
        ru: `https://globalsalah.com/ru/countries/${country}`,
        'x-default': `https://globalsalah.com/en/countries/${country}`,
      },
    },
    robots: {
 index: false,
