...
export async function generateMetadata({ params }: any) {
  ...
  return {
    ...
    description,
    alternates: {
      canonical: `https://globalsalah.com/${lang}/countries`,
      languages: {
        en: 'https://globalsalah.com/en/countries',
        es: 'https://globalsalah.com/es/countries',
        fr: 'https://globalsalah.com/fr/countries',
        ar: 'https://globalsalah.com/ar/countries',
        'zh-CN': 'https://globalsalah.com/zh-CN/countries',
        tr: 'https://globalsalah.com/tr/countries',
        de: 'https://globalsalah.com/de/countries',
        pt: 'https://globalsalah.com/pt/countries',
        ur: 'https://globalsalah.com/ur/countries',
        ru: 'https://globalsalah.com/ru/countries',
        'x-default': 'https://globalsalah.com/en/countries',
      },
    },
    robots: {
      index: false,
