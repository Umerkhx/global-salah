...
export async function generateMetadata({ params }: any) {
  ...
  return {
    ...
    alternates: {
      ...
      tr: `https://www.globalsalah.com/tr/reset-password`,
      de: `https://www.globalsalah.com/de/reset-password`,
      pt: `https://www.globalsalah.com/pt/reset-password`,
      ur: `https://www.globalsalah.com/ur/reset-password`,
      ru: `https://www.globalsalah.com/ru/reset-password`,
