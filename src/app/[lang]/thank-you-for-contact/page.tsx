...
export async function generateMetadata({ params }: any) {
  ...
  switch (lang) {
    ...
    case 'zh-CN':
      ...
      break;
    case 'tr':
      title = `Ziyaretçiler, hizmetlerimizi kullanmadan önce lütfen şartlar ve koşulları dikkatlice okuyunuz`;
      description = `Küresel namaz vakti hizmetlerimizi kullanarak şartlarımızı kabul etmiş olursunuz. Saygılı bir ortamı korumak için gizlilik politikamızı okuyunuz.`;
      break;
    case 'de':
    ...
    case 'pt':
      ...
      break;
    case 'ur':
      title = `زائرین، براہ کرم ہماری خدمات استعمال کرنے سے پہلے شرائط و ضوابط کو غور سے پڑھیں`;
      description = `ہماری عالمی نماز کے اوقات کی خدمات استعمال کرتے ہوئے، آپ ہماری شرائط و ضوابط سے اتفاق کرتے ہیں۔ براہ کرم ایک باعزت ماحول کو برقرار رکھنے کے لیے ہماری رازداری کی پالیسی پڑھیں۔`;
      break;
    default:
  ...
  return {
    ...
    description,
    alternates: {
      canonical: `https://globalsalah.com/${lang}/terms-and-conditions`,
      en: `https://globalsalah.com/en/terms-and-conditions`,
      fr: `https://globalsalah.com/fr/terms-and-conditions`,
      ar: `https://globalsalah.com/ar/terms-and-conditions`,
      es: `https://globalsalah.com/es/terms-and-conditions`,
      'zh-CN': `https://globalsalah.com/zh-CN/terms-and-conditions`,
      tr: `https://globalsalah.com/tr/terms-and-conditions`,
      de: `https://globalsalah.com/de/terms-and-conditions`,
      pt: `https://globalsalah.com/pt/terms-and-conditions`,
      ur: `https://globalsalah.com/ur/terms-and-conditions`,
      ru: `https://globalsalah.com/ru/terms-and-conditions`,
      'x-default': `https://globalsalah.com/en/terms-and-conditions`,
    },
    robots: {
 index: false,
      follow: false,
