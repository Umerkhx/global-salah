...
export async function generateMetadata({ params }: any) {
  ...
  return {
    ...
    description,
    alternates: {
      canonical: `https://globalsalah.com/${lang}/verify-code`,
      en: `https://globalsalah.com/en/verify-code`,
      fr: `https://globalsalah.com/fr/verify-code`,
      ar: `https://globalsalah.com/ar/verify-code`,
      es: `https://globalsalah.com/es/verify-code`,
      'zh-CN': `https://globalsalah.com/zh-CN/verify-code`,
      tr: `https://globalsalah.com/tr/verify-code`,
      de: `https://globalsalah.com/de/verify-code`,
      pt: `https://globalsalah.com/pt/verify-code`,
      ur: `https://globalsalah.com/ur/verify-code`,
      ru: `https://globalsalah.com/ru/verify-code`,
      'x-default': `https://globalsalah.com/en/verify-code`,
    },
    robots: {
      index: false,
      follow: false,
