...
export async function generateMetadata({ params }: any) {
  ...
  return {
    ...
    alternates: {
      ...
      tr: `https://www.globalsalah.com/tr/verify-email`,
      de: `https://www.globalsalah.com/de/verify-email`,
      pt: `https://www.globalsalah.com/pt/verify-email`,
      ur: `https://www.globalsalah.com/ur/verify-email`,
      ru: `https://www.globalsalah.com/ru/verify-email`,
