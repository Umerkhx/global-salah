...
export async function generateMetadata({ params }: any) {
  ...
  return {
    ...
    description,
    alternates: {
      canonical: `https://globalsalah.com/${lang}/question-submitted`,
      en: `https://globalsalah.com/en/question-submitted`,
      fr: `https://globalsalah.com/fr/question-submitted`,
      ar: `https://globalsalah.com/ar/question-submitted`,
      es: `https://globalsalah.com/es/question-submitted`,
      'zh-CN': `https://globalsalah.com/zh-CN/question-submitted`,
      tr: `https://globalsalah.com/tr/question-submitted`,
      de: `https://globalsalah.com/de/question-submitted`,
      pt: `https://globalsalah.com/pt/question-submitted`,
      ur: `https://globalsalah.com/ur/question-submitted`,
      ru: `https://globalsalah.com/ru/question-submitted`,
      'x-default': `https://globalsalah.com/en/question-submitted`,
    },
    robots: {
      index: false,
      follow: false,
