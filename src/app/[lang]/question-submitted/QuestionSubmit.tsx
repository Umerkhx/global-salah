          ...
          >
            <Card className="border-primary/20 shadow-md text-center">
              <CardHeader className="pb-2">
                ...
                <CardTitle className="text-2xl font-bold"> {t("forum.questionsubmit")} </CardTitle>
                <CardDescription className="capitalize">{t("forum.questionsubmitdesc")}</CardDescription>
              </CardHeader>
              <CardContent className="pb-6">
                <p className="text-muted-foreground text-sm mb-4 capitalize">
                  {t("forum.questionsubmitdetail")}
                </p>
                <Alert className="bg-muted/50 border-primary/20">
                  <Info className="h-4 w-4" />
                  <AlertDescription className="text-sm text-left">
                    {t("forum.questionsubmitnotify")}
                  </AlertDescription>
                </Alert>
