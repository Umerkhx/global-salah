...
export async function generateMetadata({ params }: any) {
  ...
  return {
    ...
    description,
    alternates: {
      canonical: `https://globalsalah.com/${lang}/add-question`,
      languages: {
        en: 'https://globalsalah.com/en/add-question',
        fr: 'https://globalsalah.com/fr/add-question',
        ar: 'https://globalsalah.com/ar/add-question',
        'zh-CN': 'https://globalsalah.com/zh-CN/add-question',
        tr: 'https://globalsalah.com/tr/add-question',
        de: 'https://globalsalah.com/de/add-question',
        pt: 'https://globalsalah.com/pt/add-question',
        ur: 'https://globalsalah.com/ur/add-question',
        ru: 'https://globalsalah.com/ru/add-question',
        'x-default': 'https://globalsalah.com/en/add-question',
      },
    },
    robots: {
 index: false,
