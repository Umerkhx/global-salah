...
export async function generateMetadata({ params }: any) {
  ...
  return {
    ...
    description,
    alternates: {
      canonical: `https://globalsalah.com/${lang}/sahih-muslim`,
      en: `https://globalsalah.com/en/sahih-muslim`,
      fr: `https://globalsalah.com/fr/sahih-muslim`,
      ar: `https://globalsalah.com/ar/sahih-muslim`,
      es: `https://globalsalah.com/es/sahih-muslim`,
      de: `https://globalsalah.com/de/sahih-muslim`,
      tr: `https://globalsalah.com/tr/sahih-muslim`,
      pt: `https://globalsalah.com/pt/sahih-muslim`,
      ur: `https://globalsalah.com/ur/sahih-muslim`,
      ru: `https://globalsalah.com/ru/sahih-muslim`,
      'zh-CN': `https://globalsalah.com/zh-CN/sahih-muslim`,
      'x-default': `https://globalsalah.com/en/sahih-muslim`,
    },
    robots: {
    index: false,
      follow: false,
