...
import { SahihMuslimDownloadDialog } from "./sahih-muslim-download-dialog"
...
export function SahihMuslimBookList({ books }: BookListProps) {
  ...
  return (
    <div className="space-y-4">
      ...
      {selectedBook && <SahihMuslimDownloadDialog isOpen={showDialog} onClose={() => setShowDialog(false)} book={selectedBook} />}
    </div>
  )
}
