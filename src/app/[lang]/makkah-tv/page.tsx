...
export async function generateMetadata({ params }: any) {
  ...
  return {
    ...
    description,
    alternates: {
      canonical: `https://globalsalah.com/${lang}/makkah-tv`,
      en: `https://globalsalah.com/en/makkah-tv`,
      fr: `https://globalsalah.com/fr/makkah-tv`,
      ar: `https://globalsalah.com/ar/makkah-tv`,
      es: `https://globalsalah.com/es/makkah-tv`,
      'zh-CN': `https://globalsalah.com/zh-CN/makkah-tv`,
      tr: `https://globalsalah.com/tr/makkah-tv`,
      de: `https://globalsalah.com/de/makkah-tv`,
      pt: `https://globalsalah.com/pt/makkah-tv`,
      ur: `https://globalsalah.com/ur/makkah-tv`,
      ru: `https://globalsalah.com/ru/makkah-tv`,
      'x-default': `https://globalsalah.com/en/makkah-tv`,
    },
    robots: {
 index: false,
      follow: false,
