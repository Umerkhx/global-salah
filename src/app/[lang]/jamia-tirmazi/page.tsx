...
export async function generateMetadata({ params }: any) {
  ...
  return {
    ...
    description,
    alternates: {
      canonical: `https://globalsalah.com/${lang}/jamia-tirmizi`,
      en: `https://globalsalah.com/en/jamia-tirmizi`,
      fr: `https://globalsalah.com/fr/jamia-tirmizi`,
      ar: `https://globalsalah.com/ar/jamia-tirmizi`,
      es: `https://globalsalah.com/es/jamia-tirmizi`,
      'zh-CN': `https://globalsalah.com/zh-CN/jamia-tirmizi`,
      tr: `https://globalsalah.com/tr/jamia-tirmizi`,
      de: `https://globalsalah.com/de/jamia-tirmizi`,
      pt: `https://globalsalah.com/pt/jamia-tirmizi`,
      ur: `https://globalsalah.com/ur/jamia-tirmizi`,
      ru: `https://globalsalah.com/ru/jamia-tirmizi`,
