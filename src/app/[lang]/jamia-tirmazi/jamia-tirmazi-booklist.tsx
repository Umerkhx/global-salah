...
import { JamiaTirmaziDownloadDialog } from "./jamia-tirmazi-download-dialog"
...
export function JamiaTirmaziBookList({ books }: BookListProps) {
  ...
  return (
    <div className="space-y-4">
      ...
      {selectedBook && <JamiaTirmaziDownloadDialog isOpen={showDialog} onClose={() => setShowDialog(false)} book={selectedBook} />}
    </div>
  )
}
