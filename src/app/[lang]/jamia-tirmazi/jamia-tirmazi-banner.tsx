...
export function JamiaTirmaziBanner() {
    ...
    {isLoading ? <div className='px-8 mt-4'>
      ...
      <div className='grid grid-cols-1 lg:grid-cols-2 gap-2 mt-4'>
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center z-20 text-white text-center px-4">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4 drop-shadow-lg">{t("jamiapage.title")}</h1>
        <p className="text-lg md:text-xl max-w-2xl drop-shadow-md">{t("jamiapage.desc")}</p>
        </div>
        </div>)}
    </>
  )
